            ...
            <ul className="menu">
              ...
              >
                ...
                <ul id="category-menu" className="submenu">
                  <li className="submenu-item">
                    <Link to="/addserviceimg" className="submenu-link">
                      Add service image
                    </Link>
                  </li>
                  <li className="submenu-item">
                    <Link to="/viewserviceimg" className="submenu-link">
                      View service image
                    </Link>
                  </li>
                </ul>
              ...
              <li
                className="sidebar-item has-sub"
                onClick={() => dropdownHandler("servicebg-menu")}
              >
                <Link className="sidebar-link">
                  <i class="bi bi-tags-fill"></i>

                  <span>Service bg image</span>
                </Link>
                <ul id="servicebg-menu" className="submenu">
                  <li className="submenu-item">
                    <Link to="/addservicebgbanner" className="submenu-link">
                      Add service bg image
                    </Link>
                  </li>
                  <li className="submenu-item">
                    <Link to="/viewservicebgbanner" className="submenu-link">
                      View service bg image
                    </Link>
                  </li>
                </ul>
              </li>
              <li
                className="sidebar-item has-sub"
                onClick={() => dropdownHandler("carouselimg-menu")}
              >
                <Link className="sidebar-link">
                  <i class="bi bi-tags-fill"></i>
                ...
                <ul id="carouselimg-menu" className="submenu">
                  <li className="submenu-item">
                    <Link to="/addcarouselimg" className="submenu-link">
                      Add Carousel image
                    </Link>
                  </li>
                  <li className="submenu-item">
                    <Link to="/viewcarouselimg" className="submenu-link">
                      View Carousel image
                    </Link>
                  </li>
                </ul>
              ...
              >
                ...
                <ul id="exp-menu" className="submenu">
                  <li className="submenu-item">
                    <Link to="/addexp" className="submenu-link">
                      Add Experience
                    </Link>
                  </li>
                  <li className="submenu-item">
                    <Link to="/viewexp" className="submenu-link">
                      View Experience
                    </Link>
                  </li>
                </ul>
