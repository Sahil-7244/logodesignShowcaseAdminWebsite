...
function ViewServiceImg() {
  ...
  const handleDelete = async (serviceImgId) => {
    try {
      await axios.post(`${process.env.REACT_APP_SITEURL}/admin/deleteserviceImg`, {
        serviceImgId
      });
  ...
  const confirmDelete = (serviceImgId) => {
      ...
      <div>
        ...
        <button
          ...
          onClick={() => {
            ...
            handleDelete(serviceImgId); // Handle delete operation
          }}
        >
          Confirm
        </button>
    ...
    <>
      <div id="app" className="d-flex">
        ...
        <div id="main" className="flex-grow-1">
          <Header /><h1>View Service Image</h1>
          <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3">
            {data.length > 0 ? (
                ...
                <div className="col mb-4" key={item._id}>
                  <div className="card" style={{ height: "100%" }}>
                    <img
                      ...
                      alt={item.serviceImgName}
                      style={{ objectFit: "cover", height: "180px" }}
                    />
                    <div className="card-body d-flex flex-column">
                      <h4 className="card-title">{item.serviceImgName}</h4>
              ...
              <p className="h3 text-center">No Service Image</p>
            )}
          </div>
        </div>
      </div>
